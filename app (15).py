...
APP_ICON_PATH = os.path.join(os.path.dirname(__file__), "static", "apple-touch-icon.png")
APP_ICON = Image.open(APP_ICON_PATH) if os.path.exists(APP_ICON_PATH) else None

# -----------------------------------------------------------------------------
# APP CONFIG
# -----------------------------------------------------------------------------
st.set_page_config(page_title="CarerMate", page_icon=APP_ICON or "🔵", layout="centered")

def install_ios_webapp_metadata():
    """Add the served icon to the page metadata used by iPhone Home Screen."""
    ...
    components.html(
        ...
        (() => {
          ...
          const icon = '/app/static/apple-touch-icon.png?v=6';
...
<style>
.stApp {
  --bg:light-dark(#f3f6fc,#091429);
  --panel:light-dark(#ffffff,#11213c);
  --panel2:light-dark(#eaf0fa,#1a2c4a);
